...
module.exports = {
  ...
  predictions: {
    ...
    filterByRt: Joi.object({
      rt: Joi.string()
        .description('Set of one or more route designators for which matching predictions are to be returned.'),
      top: Joi.number().integer()
        .description('Maximum number of predictions to be returned.'),
    }),
    requestByVid: Joi.object({
      vid: Joi.string()
        .description('Set of one or more vehicle IDs whose predictions should be returned. For example: 509,392,201,4367 will return predictions for four vehicles. A maximum of 10 identifiers can be specified.'),
    }),
